                        ...
                        <div className="bg-white backdrop-blur-lg p-8 rounded-2xl shadow-lg border border-[rgba(138,47,201,0.1)] hover:shadow-xl transition-all duration-300">
                            <div className="mb-6 space-x-6">
                                <label className="inline-flex items-center">
                                    ...
                                    />
                                    <span className="ml-2 text-[#5A108F]">Enter Company Details</span>
                                </label>
                                <label className="inline-flex items-center">
                                    <input
                                        type="radio"
                                        ...
                                        className="form-radio h-4 w-4 text-[#8B2FC9]"
                                    />
                                    <span className="ml-2 text-[#5A108F]">Upload Company PDF</span>
                                </label>
                            </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="51+">51 years and above</option>
                                        </select>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-[#5A108F] mb-1">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading || (inputMode === "text" && (!companyName || !industrySector || !targetAudience || !salesGoals)) || (inputMode === "pdf" && !pdfFile)}
                                className={`w-full py-3 px-4 mt-6 rounded-xl text-white text-base font-medium transition-all duration-300 ease-in-out transform hover:-translate-y-1 ${
                                    isLoading || (inputMode === "text" && (!companyName || !industrySector || !targetAudience || !salesGoals)) || (inputMode === "pdf" && !pdfFile)
